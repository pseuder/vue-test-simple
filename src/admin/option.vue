    ...
    methods: {
      ...
      edit_check(){//確認送出修改表單
        ...
        for(let opt of this.option_data){
          console.log(opt)
          option_map[opt['option_id']] = {'caption': opt['caption'], 'category_id': opt['category_id'], 'option_id': opt['option_id'], 
            'option_name': opt['option_name'], 'product_name': opt['product_name'], 'remarks': opt['remarks']}
        }
        if(option_map[this.option_dialog.option_id]['product_name'] == this.option_dialog.product_name&&
          option_map[this.option_dialog.option_id]['option_name'] == this.option_dialog.option_name&&
          option_map[this.option_dialog.option_id]['caption'] == this.option_dialog.caption&&
          option_map[this.option_dialog.option_id]['remarks'] == this.option_dialog.remarks){
        ...
        if(option_map[this.option_dialog.option_id]['caption'] != this.option_dialog.caption){
          this.$confirm(' 是否要將 {'+option_map[this.option_dialog.option_id]['caption']+'} 改為 {'+this.option_dialog.caption+'}', '修改', {
            confirmButtonText: '確定',
            cancelButtonText: '取消',
            type: 'warning'
            }).then(() => {
