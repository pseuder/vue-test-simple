    ...
    methods: {
      ...
      edit_check(){//確認修改表單
        ...
        for(let pro of this.product_data){
          product_map[pro['product_id']] = {'caption': pro['caption'], 'category_id': pro['category_id'], 'product_id': pro['product_id'], 
            'product_name': pro['product_name'], 'remarks': pro['remarks']}
        }
        console.log(product_map)
        if(product_map[this.product_dialog.product_id]['category_id'] == this.product_dialog.category_id&&
          product_map[this.product_dialog.product_id]['product_name'] == this.product_dialog.product_name&&
          product_map[this.product_dialog.product_id]['caption'] == this.product_dialog.caption&&
          product_map[this.product_dialog.product_id]['remarks'] == this.product_dialog.remarks){
        ...
        if(product_map[this.product_dialog.product_id]['caption'] != this.product_dialog.caption){
          this.$confirm(' 是否要將 {'+product_map[this.product_dialog.product_id]['caption']+'} 改為 {'+this.product_dialog.caption+'}', '修改', {
            confirmButtonText: '確定',
            cancelButtonText: '取消',
            type: 'warning'
            }).then(() => {
